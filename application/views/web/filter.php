    ...
    <div class="sidebar-content">
        ...
        <div class="search-form">
            ...
            <h4 style="color: #f4c23d; text-align:center">Untuk memperoleh rekomendasi</h4>
                ...
                <?php } ?>
                <input type="text" class="form-control" name="latitude" value="<?php if(isset($_COOKIE['latitude'])){ echo $_COOKIE['latitude']; } ?>" required readonly>
                <input type="text" class="form-control" name="longitude" value="<?php if(isset($_COOKIE['longitude'])){ echo $_COOKIE['longitude']; } ?>" required readonly>
            </div>

            <?php /*<div class="slider-range">
                <p>
