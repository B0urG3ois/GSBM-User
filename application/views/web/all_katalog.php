                                            ...
                                            <select name="mark" id="mark" onchange="location = this.value;">
                                                ...
                                                <?php 
                                                    ...
                                                    if($this->uri->segment(3) == 'jarak-terdekat'){
                                                        echo '<option value="'.base_url('katalog/all/jarak-terdekat').'" selected>Jarak Terdekat</option>';
                                                    }else{
                                                        echo '<option value="'.base_url('katalog/all/jarak-terdekat').'">Jarak Terdekat</option>';
                                                    }
