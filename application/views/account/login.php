                            ...
                            <div id="left-info" class="col-md-6">
                                <div class="enquiry">
                                    ...
                                    <div class="contact-form">
                                        <div class="contact-form">
                                            <form id="contact_form" action="<?php echo base_url() . 'pengajuan/login_user'; ?>" method="POST"
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-info waves-effect waves-light"
                                                        style="display: block; margin: auto; width: 100%; font-family:'Montserrat', sans-serif; text-transform:uppercase; color: #222222; background-color: #f4c23d; border-color: #f4c23d; font-size: 12px; font-weight: 700;">Login</button>
                                                </div>

                                                <hr>

                                                <div class="form-group">
                                                    <p style="color: black; text-align: center;">Belum punya akun?<a href="<?php echo base_url() . 'pengajuan/regis_view'; ?>"> Daftar</a></p>
                                                </div>
                                                <br>
                                            </form>
                                        </div>
