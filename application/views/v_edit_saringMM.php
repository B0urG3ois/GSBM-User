			...
			<div class="col-12">
				<div class="card">
					...
					<section class="content">
						...
						<?php foreach($saringMM as $sMM) { ?>
						<!-- controller/method -->
						<form action="<?php echo base_url().'bengkel/update_saringMM'; ?>" method="post"
							...
							<div class="card-body bg-light">
								...
								<div class="form-group row align-items-center m-b-0">
									...
									<div class="col-9 border-left p-b-10 p-t-10">
										<input type="text" name="ID_MM" readonly class="form-control"
											value="<?php echo $sMM->ID_MM ?>">
									</div>
								</div>
								<div class="form-group row align-items-center m-b-0">
